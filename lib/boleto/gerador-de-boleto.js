...
var GeradorDeBoleto = (function() {
		...
		return new Promise((resolve)=> {
			...
			boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
				...
				pdf.font('codigoDeBarras')
					...
					.text(i25(codigoDeBarras), args.ajusteX + margemDoSegundoBlocoLayout, args.ajusteY + linha212 , {
						lineBreak: false,
						width: 340,
						align: 'left'
					});
				...
				boleto.getLocaisDePagamento().forEach(function(localDePagamento, indice) {
					...
					pdf.font('normal')
						.fontSize(args.tamanhoDaFonteDoTitulo+2)
						.text(localDePagamento, args.ajusteX + margemDoSegundoBloco, args.ajusteY + (terceiraLinha + 2 - args.tamanhoDaFonte + (indice * args.tamanhoDaFonte)+2), {
							lineBreak: false,
							width: 400,
							align: 'left'
						});
				...
				if (enderecoDoPagador) {
					...
					if (enderecoDoPagador.getPrimeiraLinha()) {
						pdf.font('normal')
							.fontSize(args.tamanhoDaFonte)
							.text(enderecoDoPagador.getPrimeiraLinha(), args.ajusteX + margemDoSegundoBloco, args.ajusteY + tituloDaSetimaLinha + 115 + 10 + espacamento, {
								lineBreak: false,
								width: 535,
								align: 'left'
							});
					...
					if (enderecoDoPagador.getSegundaLinha()) {
						pdf.font('normal')
							.fontSize(args.tamanhoDaFonte)
							.text(enderecoDoPagador.getSegundaLinha(), args.ajusteX + margemDoSegundoBloco, args.ajusteY + tituloDaSetimaLinha + 115 + 10 + espacamento, {
								lineBreak: false,
								width: 535,
								align: 'left'
							});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Autenticação Mecânica', args.ajusteX + 360, args.ajusteY + tituloDaSetimaLinha + 120, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
	...
	GeradorDeBoleto.prototype.gerarCarne = function(args) {
		...
		return new Promise((resolve)=> {
			...
			boletos.forEach(function escreveOsDadosDoBoleto(boleto, indice) {
				...
				var margemDaLinhaSeparadora = 10,
					divisoresVerticais = (linha4Opcional || linha3) + (2 * margemDaLinhaSeparadora) - 7,
					margemDoSegundoBloco = 150,
					margemDoSegundoBlocoLayout = margemDoSegundoBloco - 4,
					alturaDoLogotipoDoBanco = 18;

				var linha21 = divisoresVerticais + alturaDoLogotipoDoBanco + 5;
				pdf.moveTo(args.ajusteX + margemDoSegundoBlocoLayout, args.ajusteY + linha21)
					.lineTo(args.ajusteX + 571, args.ajusteY + linha21)
					.undash()
					.stroke(args.corDoLayout);

				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha21)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha21)
					.stroke(args.corDoLayout);

				var linha22 = linha21 + ESPACO_ENTRE_LINHAS + 5;
				pdf.moveTo(args.ajusteX + margemDoSegundoBlocoLayout, args.ajusteY + linha22)
					.lineTo(args.ajusteX + 571, args.ajusteY + linha22)
					.stroke(args.corDoLayout);

				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha22)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha22)
					.stroke(args.corDoLayout);
				...
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha23)
				.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha23)
				.stroke(args.corDoLayout);
				...
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha24)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha24)
					.stroke(args.corDoLayout);
				...
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha25)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha25)
					.stroke(args.corDoLayout);

				var camposLaterais = 480,
				    camposLateraisEsquerda = 27,
					linha26 = linha25 + ESPACO_ENTRE_LINHAS;

				pdf.moveTo(args.ajusteX + camposLateraisEsquerda, args.ajusteY + linha26)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha26)
					.stroke(args.corDoLayout);

					pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha26)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha26)
					.stroke(args.corDoLayout);
				...
				var linha27 = linha26 + ESPACO_ENTRE_LINHAS;
				pdf.moveTo(args.ajusteX + camposLateraisEsquerda, args.ajusteY + linha27)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha27)
					.stroke(args.corDoLayout);
				...
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha27)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha27)
					.stroke(args.corDoLayout);
				...
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha28)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha28)
					.stroke(args.corDoLayout);
				...
				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha29)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha29)
					.stroke(args.corDoLayout);

				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha29 + ESPACO_ENTRE_LINHAS)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha29+ ESPACO_ENTRE_LINHAS)
					.stroke(args.corDoLayout);

				// pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha29 + (ESPACO_ENTRE_LINHAS*2))
				// 	.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha29+ (ESPACO_ENTRE_LINHAS*2))
				// 	.stroke(args.corDoLayout);

				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linha29 + (ESPACO_ENTRE_LINHAS*3)+15)
					.lineTo(args.ajusteX + margemDoSegundoBlocoLayout-10, args.ajusteY + linha29+ (ESPACO_ENTRE_LINHAS*3)+15)
					.stroke(args.corDoLayout);
				...
				pdf.moveTo(args.ajusteX + 26, args.ajusteY + linha21)
					.lineTo(args.ajusteX + 26, args.ajusteY + linha211+45)
					.stroke(args.corDoLayout);

				pdf.moveTo(args.ajusteX + 135, args.ajusteY + linha21)
					.lineTo(args.ajusteX + 135, args.ajusteY + linha211+45)
					.stroke(args.corDoLayout);
				...
				var coluna25 = coluna24 + 70;
				pdf.moveTo(args.ajusteX + coluna25, args.ajusteY + linha23)
					.lineTo(args.ajusteX + coluna25, args.ajusteY + linha24)
					.stroke(args.corDoLayout);

				var coluna26 = coluna25 + 70;
				pdf.moveTo(args.ajusteX + coluna26, args.ajusteY + linha23)
					.lineTo(args.ajusteX + coluna26, args.ajusteY + linha24)
					.stroke(args.corDoLayout);

				var coluna27 = coluna26 + 60;
				pdf.moveTo(args.ajusteX + coluna27, args.ajusteY + linha23)
					.lineTo(args.ajusteX + coluna27, args.ajusteY + linha24)
					.stroke(args.corDoLayout);
				...
				var coluna29 = coluna28 + 30.5;
				pdf.moveTo(args.ajusteX + coluna29, args.ajusteY + linha24)
					.lineTo(args.ajusteX + coluna29, args.ajusteY + linha25)
					.stroke(args.corDoLayout);

				var coluna210 = coluna29 + 30;
				pdf.moveTo(args.ajusteX + coluna210, args.ajusteY + linha24)
					.lineTo(args.ajusteX + coluna210, args.ajusteY + linha25)
					.stroke(args.corDoLayout);

				var coluna211 = coluna210 + 60;
				pdf.moveTo(args.ajusteX + coluna211, args.ajusteY + linha24)
					.lineTo(args.ajusteX + coluna211, args.ajusteY + linha25)
					.stroke(args.corDoLayout);
				...
				var coluna212 = 275;
				pdf.moveTo(args.ajusteX + coluna212, args.ajusteY + divisoresVerticais)
					.lineTo(args.ajusteX + coluna212, args.ajusteY + linha21-10)
					.stroke(args.corDoLayout);

				var coluna213 = coluna212 + 1;
				pdf.moveTo(args.ajusteX + coluna213, args.ajusteY + divisoresVerticais)
					.lineTo(args.ajusteX + coluna213, args.ajusteY + linha21-10)
					.stroke(args.corDoLayout);

				var coluna214 = coluna213 + 1;
				

				var coluna215 = coluna214 + 28.5;
				pdf.moveTo(args.ajusteX + coluna215, args.ajusteY + divisoresVerticais)
					.lineTo(args.ajusteX + coluna215, args.ajusteY + linha21-10)
					.stroke(args.corDoLayout);

				var coluna216 = coluna215 + 1;
				pdf.moveTo(args.ajusteX + coluna216, args.ajusteY + divisoresVerticais)
					.lineTo(args.ajusteX + coluna216, args.ajusteY + linha21-10)
					.stroke(args.corDoLayout);

				var linhaSeparadora = (linha4Opcional || linha3) + margemDaLinhaSeparadora;

				pdf.moveTo(args.ajusteX + 27, args.ajusteY + linhaSeparadora-4-5)
					.lineTo(args.ajusteX + 572, args.ajusteY + linhaSeparadora-4-5)
					.dash(3, { space: 5 })
					.stroke(args.corDoLayout);
				...
				var caminhoParaTesoura = path.join(__dirname, 'imagens/tesoura128.png');
				pdf.image(caminhoParaTesoura, args.ajusteX + margemDoSegundoBlocoLayout, args.ajusteY + linhaSeparadora - 12.2, {
					width: 10
				});
				...
				var primeiraLinha = linha1,
					diferencaEntreTituloEValor = 3;
				//	tituloDaPrimeiraLinha = primeiraLinha - diferencaEntreTituloEValor;
				...
				const segundaLinha2 = linha21 - 23.25;
				const codigoDeBarras = banco.geraCodigoDeBarrasPara(boleto);
				const linhaDigitavel = GeradorDeLinhaDigitavel(codigoDeBarras, banco);
				...
				pdf.image(banco.getImagem(), args.ajusteX + 27, args.ajusteY + segundaLinha2, {
					height: 13
				});

				pdf.font('negrito')
					.fontSize(args.tamanhoDaLinhaDigitavel)
					.text(banco.getNumeroFormatadoComDigito(), args.ajusteX + margemDoSegundoBlocoLayout + 130, args.ajusteY + segundaLinha2, {
						lineBreak: false,
						width: 30,
						align: 'center'
					});
					...
					pdf.font('negrito')
					.fontSize(args.tamanhoDaLinhaDigitavel)
					.text(banco.getNumeroFormatadoComDigito(), args.ajusteX  + 90, args.ajusteY + segundaLinha2, {
						lineBreak: false,
						width: 30,
						align: 'center'
					});
				...
				var terceiraLinha = segundaLinha2 + 33,
					tituloDaTerceiraLinha = terceiraLinha - diferencaEntreTituloEValor,
					tituloDaTerceiraLinhaLateral = terceiraLinha - diferencaEntreTituloEValor,
					colunaLateral = 482;
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.localDoPagamento, args.ajusteX + tituloLocalDoPagamento, args.ajusteY + tituloDaTerceiraLinha - 5, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				boleto.getLocaisDePagamento().forEach(function(localDePagamento, indice) {
					...
					pdf.font('normal')
						.fontSize(args.tamanhoDaFonteDoTitulo+3)
						.text(localDePagamento, args.ajusteX + margemDoSegundoBloco, args.ajusteY + (terceiraLinha + 2 - args.tamanhoDaFonte + (indice * args.tamanhoDaFonte)+3), {
							lineBreak: false,
							width: 297,
							align: 'left'
						});
				...
				var tamanhoDasCelulasADireita = 80.5;

				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Vencimento', args.ajusteX + colunaLateral, args.ajusteY + tituloDaTerceiraLinhaLateral - 5, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Vencimento', args.ajusteX + 27, args.ajusteY + tituloDaTerceiraLinhaLateral - 5, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(datas.getVencimentoFormatado(), args.ajusteX + 27, args.ajusteY + terceiraLinha, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});

				var quartaLinha = terceiraLinha + 12,
					tituloDaQuartaLinhaLateral = quartaLinha - diferencaEntreTituloEValor;

				var tituloBeneficiario = margemDoSegundoBloco;
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Beneficiário', args.ajusteX + tituloBeneficiario, args.ajusteY + tituloDaQuartaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(beneficiario.getIdentificacao(), args.ajusteX + margemDoSegundoBloco, args.ajusteY + quartaLinha+5, {
						lineBreak: false,
						width: 400,
						align: 'left'
					});
					...
					pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Beneficiário', args.ajusteX + 27, args.ajusteY + tituloDaQuartaLinhaLateral+122, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(beneficiario.getIdentificacao(), args.ajusteX + 27, args.ajusteY + tituloDaQuartaLinhaLateral+128, {
						lineBreak: false,
						width: 100,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.agenciaECodigoDoBeneficiario, args.ajusteX + colunaLateral, args.ajusteY + tituloDaQuartaLinhaLateral+2, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.agenciaECodigoDoBeneficiario, args.ajusteX + 27, args.ajusteY + tituloDaQuartaLinhaLateral+2, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(banco.getAgenciaECodigoBeneficiario(boleto), args.ajusteX + colunaLateral, args.ajusteY + quartaLinha+5, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'right'
					});
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(banco.getAgenciaECodigoBeneficiario(boleto), args.ajusteX + 27, args.ajusteY + quartaLinha+5, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.dataDocumento, args.ajusteX + tituloDataDocumento, args.ajusteY + tituloDaQuintaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(datas.getDocumentoFormatado(), args.ajusteX + margemDoSegundoBloco, args.ajusteY + quintaLinha+5, {
						lineBreak: false,
						width: 61.5,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(boleto.getNumeroDoDocumentoFormatado(), args.ajusteX + margemDoSegundoBloco + 63, args.ajusteY + quintaLinha+4, {
						lineBreak: false,
						width: 84,
						align: 'left'
					});

				var tituloNumeroDoDocumento = tituloDataDocumento + 63,
					tituloCip = tituloNumeroDoDocumento;

				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.numeroDoDocumento, args.ajusteX + tituloNumeroDoDocumento, args.ajusteY + tituloDaQuintaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});

				var tituloEspecieDoc = tituloNumeroDoDocumento + 70;
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.especieDoDocumento, args.ajusteX + tituloEspecieDoc, args.ajusteY + tituloDaQuintaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(boleto.getEspecieDocumento(), args.ajusteX + margemDoSegundoBloco + 68 + 30, args.ajusteY + quintaLinha+5, {
						lineBreak: false,
						width: 81,
						align: 'center'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Aceite', args.ajusteX + tituloAceite, args.ajusteY + tituloDaQuintaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(boleto.getAceiteFormatado(), args.ajusteX + margemDoSegundoBloco + 68 + 90 + 25, args.ajusteY + quintaLinha+4, {
						lineBreak: false,
						width: 55,
						align: 'center'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(datas.getProcessamentoFormatado(), args.ajusteX + margemDoSegundoBloco + 68 + 90 + 86 + 30, args.ajusteY + quintaLinha+4, {
						lineBreak: false,
						width: 93.5,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.dataDeProcessamento, args.ajusteX + tituloDataProcessamento, args.ajusteY + tituloDaQuintaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.nossoNumero, args.ajusteX + colunaLateral, args.ajusteY + tituloDaQuintaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.nossoNumero, args.ajusteX + 27, args.ajusteY + tituloDaQuintaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(banco.getNossoNumeroECodigoDocumento(boleto), args.ajusteX + colunaLateral, args.ajusteY + quintaLinha+2, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'right'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(banco.getNossoNumeroECodigoDocumento(boleto), args.ajusteX + 27, args.ajusteY + quintaLinha+2, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Uso do Banco', args.ajusteX + tituloUsoDoBancoX, args.ajusteY + tituloDaSextaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.carteira, args.ajusteX + tituloCarteira, args.ajusteY + tituloDaSextaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(banco.getCarteiraTexto(beneficiario), args.ajusteX + margemDoSegundoBloco + 80, args.ajusteY + sextaLinha+4, {
						lineBreak: false,
						width: 71,
						align: 'center'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(boleto.getEspecieMoeda(), args.ajusteX + margemDoSegundoBloco + 104.5, args.ajusteY + sextaLinha+4, {
						lineBreak: false,
						width: 71,
						align: 'center'
					});

				var tituloEspecieMoeda = tituloCarteira + 30;
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.especie, args.ajusteX + tituloEspecieMoeda, args.ajusteY + tituloDaSextaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});

				var tituloQuantidadeMoeda = tituloEspecieMoeda + 40;
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.quantidade, args.ajusteX + tituloQuantidadeMoeda, args.ajusteY + tituloDaSextaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});

				var tituloValorMoeda = tituloQuantidadeMoeda + 60;
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.valor, args.ajusteX + tituloValorMoeda, args.ajusteY + tituloDaSextaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.igualDoValorDoDocumento + titulos.valorDoDocumento, args.ajusteX + colunaLateral, args.ajusteY + tituloDaSextaLinha+2, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
					...
					pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.igualDoValorDoDocumento + titulos.valorDoDocumento, args.ajusteX + 27, args.ajusteY + tituloDaSextaLinha+2, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(boleto.getValorFormatadoBRL(), args.ajusteX + colunaLateral, args.ajusteY + sextaLinha+4, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'right'
					});
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(boleto.getValorFormatadoBRL(), args.ajusteX + 27, args.ajusteY + sextaLinha+4, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.instrucoes, args.ajusteX + margemDoSegundoBloco, args.ajusteY + tituloDaSetimaLinha+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				boleto.getInstrucoes().forEach(function(instrucao, indice) {
					pdf.font('normal')
						.fontSize(args.tamanhoDaFonte)
						.text(instrucao, args.ajusteX + margemDoSegundoBloco, args.ajusteY + instrucaoY +4+ (indice * args.tamanhoDaFonte), {
							lineBreak: false,
							width: 400,
							align: 'left'
						});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Pagador', args.ajusteX + margemDoSegundoBloco, args.ajusteY + tituloDaSetimaLinha + 77, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(pagador.getIdentificacao(), args.ajusteX + margemDoSegundoBloco, args.ajusteY + tituloDaSetimaLinha + 82.5, {
						lineBreak: false,
						width: 535,
						align: 'left'
					});
				...
				if (enderecoDoPagador) {
					...
					if (enderecoDoPagador.getPrimeiraLinha()) {
						pdf.font('normal')
							.fontSize(args.tamanhoDaFonte)
							.text(enderecoDoPagador.getPrimeiraLinha(), args.ajusteX + margemDoSegundoBloco, args.ajusteY + tituloDaSetimaLinha + 82.5 + espacamento, {
								lineBreak: false,
								width: 535,
								align: 'left'
							});
					...
					if (enderecoDoPagador.getSegundaLinha()) {
						pdf.font('normal')
							.fontSize(args.tamanhoDaFonte)
							.text(enderecoDoPagador.getSegundaLinha(), args.ajusteX + margemDoSegundoBloco, args.ajusteY + tituloDaSetimaLinha + 82.5 + espacamento, {
								lineBreak: false,
								width: 535,
								align: 'left'
							});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('Código de Baixa', args.ajusteX + 370, args.ajusteY + tituloDaSetimaLinha + 80, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				// pdf.font('negrito')
				// 	.fontSize(args.tamanhoDaFonteDoTitulo)
				// 	.text('Autenticação Mecânica', args.ajusteX + 360, args.ajusteY + tituloDaSetimaLinha , {
				// 		lineBreak: false,
				// 		width: 294,
				// 		align: 'left'
				// 	});
				...
				// pdf.font('negrito')
				// 	.fontSize(args.tamanhoDaFonteDoTitulo + 1)
				// 	.text('FICHA DE COMPENSAÇÃO', args.ajusteX + 421, args.ajusteY + tituloDaSetimaLinha , {
				// 		lineBreak: false,
				// 		width: 150,
				// 		align: 'right'
				// 	});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('(-) Desconto / Abatimento', args.ajusteX + colunaLateral, args.ajusteY + tituloDaSetimaLinhaLateral+2, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('(-) Desconto / Abatimento', args.ajusteX + 27, args.ajusteY + tituloDaSetimaLinhaLateral+2, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(boleto.getValorDescontosFormatadoBRL(), args.ajusteX + colunaLateral, args.ajusteY + setimaLinhaLateral+2, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'right'
					});
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(boleto.getValorDescontosFormatadoBRL(), args.ajusteX + 27, args.ajusteY + setimaLinhaLateral+2, {
						lineBreak: false,
						width: tamanhoDasCelulasADireita,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('(-) Outras Deduções', args.ajusteX + colunaLateral, args.ajusteY + tituloDaOitavaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(boleto.getValorDeducoesFormatadoBRL(), args.ajusteX + colunaLateral, args.ajusteY + oitavaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
					...
					pdf.font('normal')
					.fontSize(args.tamanhoDaFonte)
					.text(boleto.getValorDeducoesFormatadoBRL(), args.ajusteX + 27, args.ajusteY + oitavaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('(-) Outras Deduções', args.ajusteX +27 , args.ajusteY + tituloDaOitavaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.moraMulta, args.ajusteX + colunaLateral, args.ajusteY + tituloDaNonaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text(titulos.moraMulta, args.ajusteX + 27, args.ajusteY + tituloDaNonaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('(+) Outros Acréscimos', args.ajusteX + colunaLateral, args.ajusteY + tituloDaDecimaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('(+) Outros Acréscimos', args.ajusteX + 27, args.ajusteY + tituloDaDecimaLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('(=) Valor Cobrado', args.ajusteX + colunaLateral, args.ajusteY + tituloDaDecimaPrimLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
				...
				pdf.font('negrito')
					.fontSize(args.tamanhoDaFonteDoTitulo)
					.text('(=) Valor Cobrado', args.ajusteX + 27, args.ajusteY + tituloDaDecimaPrimLinhaLateral+2, {
						lineBreak: false,
						width: 294,
						align: 'left'
					});
